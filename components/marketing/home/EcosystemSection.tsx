...
import { RevealOnScroll, SlideUp, ScaleIn } from "@/components/ui/motion";
...
export function EcosystemSection() {
  return (
    <Section className="bg-surface-elevated py-section-md border-border" id="ecosystem">
      <Container className="flex flex-col items-center">
        <RevealOnScroll className="flex flex-col items-center text-center">
          <Heading level={2} className="mb-4">
            The Infalex Ecosystem
          </Heading>
          <p className="text-body text-foreground-muted max-w-2xl mb-16">
        ...
        <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          {/* Root Node */}
          <RevealOnScroll delay={0.2} className="relative z-20 bg-primary/10 border border-primary/20 px-8 py-4 rounded-full mb-8 shadow-glow">
            <span className="font-bold text-primary uppercase tracking-widest text-sm">Infalex Platform</span>
          </RevealOnScroll>
          ...
          <div className="relative w-full grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
            <RevealOnScroll delay={1.2}>
              <SpotlightCard className="flex flex-col items-center text-center p-8 h-full border-border/50">
                <div className="mb-4 w-12 h-12 flex items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:scale-110 transition-transform duration-300">
          ...
          <RevealOnScroll delay={1.6}>
            <div className="relative z-10 mt-16 bg-surface/50 border border-border/50 border-dashed px-6 py-3 rounded-full hover:border-primary/30 transition-colors">
              <span className="font-medium text-foreground-subtle text-sm flex items-center gap-2">
