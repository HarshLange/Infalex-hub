      ...
      <Section className="pt-0">
        <Container size="md">
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-1 bg-border/50 border border-border2 rounded-3xl overflow-hidden p-[1px]">
              <div className="bg-surface hover:bg-surface-hover transition-colors p-8 text-center rounded-t-[23px] md:rounded-tr-none md:rounded-l-[23px]">
                <div className="font-heading text-4xl font-bold text-text mb-2">2026</div>
                <div className="text-sm text-text-subtle font-medium uppercase tracking-wider">Founded</div>
              </div>
              <div className="bg-surface hover:bg-surface-hover transition-colors p-8 text-center rounded-none">
                <div className="font-heading text-4xl font-bold text-text mb-2">MSME</div>
                <div className="text-sm text-text-subtle font-medium uppercase tracking-wider">Registered in India</div>
              </div>
              <div className="bg-surface hover:bg-surface-hover transition-colors p-8 text-center rounded-b-[23px] md:rounded-bl-none md:rounded-r-[23px]">
                <div className="font-heading text-4xl font-bold text-text mb-2">10+</div>
                <div className="text-sm text-text-subtle font-medium uppercase tracking-wider">AI Features</div>
              </div>
            </div>

            <div className="bg-surface border border-border2 hover:border-border transition-colors rounded-3xl p-8 lg:p-10 relative overflow-hidden group">
              ...
              <h2 className="text-2xl font-heading font-bold text-text mb-4 flex items-center gap-3">
                Company Identity
                <span className="text-[10px] font-semibold tracking-wider uppercase bg-accent/10 text-accent border border-accent/20 px-3 py-1 rounded-full font-sans">India</span>
              </h2>
            ...
            <div className="bg-surface border border-border2 hover:border-border transition-colors rounded-3xl p-8 lg:p-10 relative overflow-hidden group">
              ...
              <h2 className="text-2xl font-heading font-bold text-text mb-4 flex items-center gap-3">
                MSME Registration
                <span className="text-[10px] font-semibold tracking-wider uppercase bg-accent/10 text-accent border border-accent/20 px-3 py-1 rounded-full font-sans">Verified</span>
              </h2>
              <p className="text-text-muted leading-relaxed">
            ...
            <div className="bg-surface border border-border2 hover:border-border transition-colors rounded-3xl p-8 lg:p-10 relative overflow-hidden group">
              <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-accent/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              <Search className="w-8 h-8 text-accent mb-6" />
              <h2 className="text-2xl font-heading font-bold text-text mb-4 flex items-center gap-3">
                What We Do
              </h2>
              <p className="text-text-muted leading-relaxed">
